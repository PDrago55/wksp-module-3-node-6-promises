...
the **wait part** is the problem as we wont know how long to wait...
---

#### The Node solution

- Any incoming / outgoing (I/O) functions are made _asynchronous_
...
```
try - catch is different to .catch
<!-- 
...
- it allows us to chain promises within our code... 
...
The callback-based code above becomes: (same code as above but now passed as a promise)
